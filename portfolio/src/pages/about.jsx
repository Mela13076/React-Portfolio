        ...
        <div className="about-page">
            ...
            <div className="content-section">
                ...
                <div className="professional-journey square">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit ipsa asperiores illum magnam, velit totam quis numquam atque voluptatibus, earum delectus nisi magni, nihil porro ipsum voluptates at in? Laboriosam?</p>
                </div>
                ...
                <div className="personal-interest square">
                    <h2 className="neon-text-about">Personal Interest</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit ipsa asperiores illum magnam, velit totam quis numquam atque voluptatibus, earum delectus nisi magni, nihil porro ipsum voluptates at in? Laboriosam?</p>
                </div>
